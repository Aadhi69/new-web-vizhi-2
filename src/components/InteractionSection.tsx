    ...
    <section className="py-28 sm:py-32 md:py-40 lg:py-48 bg-[#050505] relative border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col gap-5 sm:gap-6 z-10">
          <div className="vizhi-kicker text-cyan-400 font-medium tracking-wide text-sm bg-cyan-950/30 w-fit px-4 py-2 rounded-full border border-cyan-500/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {gestures.map((gesture, i) => (
              ...
              >
                ...
                <div>
                  <h3 className="vizhi-card-title text-white font-medium mb-1">
                    {gesture.name}
                  </h3>
                  <p className="vizhi-card-copy text-white/40 text-sm leading-relaxed">
                    {gesture.desc}
                  </p>
                </div>
              </motion.div>
