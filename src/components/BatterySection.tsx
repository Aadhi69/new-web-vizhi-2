...
export default function BatterySection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-28 sm:py-32 md:py-40 lg:py-48 bg-[#0a0a0a] overflow-hidden border-t border-white/5 border-b"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="vizhi-section-lead text-base sm:text-lg md:text-xl text-white/50 font-light max-w-lg mb-6 sm:mb-7 md:mb-8">
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-4">
              ...
              <p className="vizhi-card-title text-white/80 font-medium">
        ...
        <div className="relative glass-panel rounded-4xl p-12 aspect-square flex items-center justify-center overflow-hidden">
          ...
          <div className="w-32 h-64 border border-white/10 rounded-2xl relative overflow-hidden bg-black flex flex-col items-center p-2 shadow-inner">
            ...
            >
              <BatteryCharging
                size={24}
                className="text-green-400 absolute top-4 left-1/2 -translate-x-1/2 drop-shadow-[0_0_10px_rgba(74,222,128,0.8)]"
              />
              <motion.div
