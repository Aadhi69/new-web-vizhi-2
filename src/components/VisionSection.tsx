...
export default function VisionSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="py-28 sm:py-32 md:py-40 lg:py-48 bg-[#050505] relative flex flex-col items-center justify-center text-center overflow-hidden"
    >
      {/* Ambient Global Glow */}
      ...
      >
        ...
        <Link
          href="/contact"
          className="px-8 py-4 rounded-full bg-cyan-500 hover:bg-cyan-400 text-black font-semibold tracking-wide hover:scale-105 transition-all duration-300 shadow-[0_0_30px_rgba(0,229,255,0.3)] text-2xl"
        >
          Contact Us
        </Link>
      </motion.div>
