...
export default function OverlayHUD({
  ...
  useEffect(() => {
    if (
      type.toLowerCase().includes("manufactur") ||
      type.toLowerCase().includes("educat")
    ) {
      ...
      >
        <div
          className={`hud-panel w-full p-0 sm:p-0 ${
            isFieldService
              ? "max-w-6xl h-full flex flex-col min-h-0"
              : "max-w-5xl"
          }`}
        >
          {/* Header / Title */}
          ...
          >
            ...
            <div
              className={`${isFieldService ? "text-[10px]" : "text-xs"} text-(--vizhi-muted)`}
            >
              3D Preview Mode
            </div>
          </div>
            ...
            <div className="flex flex-col gap-6 w-full items-center">
              ...
              <div className="flex w-full justify-between items-center mb-4">
                <div className="flex items-center gap-3 bg-black/60 border border-[rgba(0,201,167,0.3)] rounded-full px-5 py-2 shadow-none sm:shadow-lg">
                  ...
                  <span className="text-[11px] font-black tracking-widest text-(--vizhi-teal) uppercase">
                ...
                {!showInitialContent && (
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-(--vizhi-teal) flex items-center justify-center text-[10px] font-black text-black">
                      3
                    </div>
                  ...
                  {showInitialContent ? (
                    ...
                    >
                      ...
                      <div className="space-y-5">
                        <h3 className="text-[11px] font-black text-(--vizhi-teal) uppercase tracking-[0.2em] mb-4 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                          Assembly Sequence
                        </h3>
                        {[
                          {
                            step: 1,
                            text: "Scan component QR code",
                            status: "completed",
                          },
                          {
                            step: 2,
                            text: "Verify part alignment (Axis-Z)",
                            status: "completed",
                          },
                          {
                            step: 3,
                            text: "Apply M6 fastener to Housing-A",
                            status: "active",
                          },
                          {
                            step: 4,
                            text: "Calibrate torque to 45Nm",
                            status: "pending",
                          },
                          {
                            step: 5,
                            text: "Final quality check & seal",
                            status: "pending",
                          },
                        ].map((s) => (
                          <div
                          ...
                          >
                            <div
                              className={`w-7 h-7 rounded-full flex items-center justify-center text-[11px] font-black shadow-lg ${
                                s.status === "active"
                                  ? "bg-(--vizhi-teal) text-black"
                                  : "bg-white/20 text-(--vizhi-teal)"
                              }`}
                            >
                              {s.status === "completed" ? "✓" : s.step}
                            </div>
                            <span
                              className={`text-[14px] drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] ${s.status === "active" ? "text-(--vizhi-teal) font-black" : "text-(--vizhi-teal) font-bold"}`}
                            >
                              {s.text}
                            </span>
                            {s.status === "active" && (
                    ...
                    >
                      ...
                      <div className="hud-stat-card bg-black/95 border-(--vizhi-teal) p-6 sm:p-10 rounded-2xl shadow-none sm:shadow-[0_0_40px_rgba(0,201,167,0.4)] border-2">
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <span className="text-[12px] sm:text-[14px] font-black text-(--vizhi-teal) uppercase tracking-[0.3em] drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                            AI LIVE GUIDANCE
                          </span>
                        </div>
                        <p className="text-[16px] sm:text-[22px] text-(--vizhi-teal) font-black leading-snug italic mb-8 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
                          "Detecting slight misalignment in Housing-A. Rotate
                          component 3° clockwise for optimal fastener seating."
                        </p>
                        <div className="flex flex-wrap items-center gap-6 sm:gap-10 pt-8 border-t border-white/20">
                          <div>
                            <div className="text-[10px] sm:text-[12px] text-(--vizhi-teal) font-black uppercase tracking-wider mb-1 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                              Confidence
                            </div>
                            <div className="text-xl sm:text-2xl font-mono text-(--vizhi-teal) font-black drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                              99.4%
                            </div>
                          </div>
                          <div>
                            <div className="text-[10px] sm:text-[12px] text-white/80 font-black uppercase tracking-wider mb-1 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                              Deviation
                            </div>
                            <div className="text-xl sm:text-2xl font-mono text-orange-400 font-black drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                              0.02mm
                            </div>
                          </div>
                          <div className="ml-0 sm:ml-auto w-full sm:w-auto">
                            ...
                            <div className="text-xs sm:text-sm font-black text-black bg-(--vizhi-teal) px-3 py-1 rounded shadow-lg inline-block">
                              SmartWrench v4
                            </div>
                          </div>
                        </div>
            ...
            <div className="flex flex-col gap-4 w-full h-full max-w-6xl mx-auto px-4 pb-2">
              ...
              <div className="flex w-full justify-between items-center mb-2 px-2">
                <div className="flex items-center justify-center gap-2 sm:gap-3 bg-black/60 border border-[rgba(0,201,167,0.3)] rounded-full px-3 sm:px-5 py-1 sm:py-2 shadow-none sm:shadow-lg">
                  ...
                  <span className="text-[9px] sm:text-[11px] font-black tracking-widest text-(--vizhi-teal) uppercase leading-none">
                    Interactive Anatomy Active
                  </span>
                </div>
                <div className="bg-black/80 border border-white/10 rounded-full px-3 sm:px-4 py-1 sm:py-2 flex items-center justify-center">
                  <span className="text-[9px] sm:text-[12px] font-black text-white/60 uppercase tracking-widest leading-none">
                    Unit 4: Cardiology
                  </span>
                </div>
              </div>
                      ...
                      <div className="relative w-48 h-48 sm:w-80 sm:h-80 flex items-center justify-center">
                        ...
                        >
                          <div className="flex items-center gap-1 sm:gap-2">
                            <span className="text-[7px] sm:text-[11px] font-black text-(--vizhi-teal) uppercase">
                              Pinch Zoom
                            </span>
                            <Search
                              size={12}
                              className="text-(--vizhi-teal) sm:w-[14px]"
                            />
                          </div>
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                          ...
                          >
                            ...
                            <Image
                              ...
                              style={{
                                filter:
                                  "invert(72%) sepia(91%) saturate(3660%) hue-rotate(85deg) brightness(108%) contrast(126%)",
                              }}
                            />
                            {/* Subtle Glow Overlay */}
                          ...
                          <div className="mt-2 sm:mt-4 px-3 sm:px-4 py-1 bg-black/80 border border-(--vizhi-teal) rounded-full">
                            <span className="text-[8px] sm:text-[10px] font-black text-(--vizhi-teal) uppercase tracking-[0.2em]">
                              Human Heart (3D)
                            </span>
                          </div>
                        </div>
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        <div className="bg-black/80 p-6 rounded-2xl border-2 border-(--vizhi-teal) shadow-[0_0_30px_rgba(0,201,167,0.2)]">
                          <div className="flex items-center gap-2 mb-4">
                            <Rotate3d
                              size={16}
                              className="text-(--vizhi-teal)"
                            />
                            <h3 className="text-[14px] font-black text-(--vizhi-teal) uppercase tracking-widest">
                              Dissection Analysis
                            </h3>
                          </div>
                          <div className="space-y-3">
                            {[
                              ...
                              >
                                <span className="text-[11px] font-black text-white/60 uppercase">
                                  {item.label}
                                </span>
                                <span
                                  className={`text-[12px] font-black ${item.status}`}
                                >
                                  {item.value}
                                </span>
                              </div>
                        ...
                        <div className="flex gap-4">
                          <button className="flex-1 bg-(--vizhi-teal) text-black font-black py-3 rounded-xl text-[10px] uppercase shadow-lg">
                            Isolate Chambers
                          </button>
                          <button className="flex-1 bg-white/5 border border-white/20 text-white font-black py-3 rounded-xl text-[10px] uppercase">
                            Reset Model
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="bg-black/90 border-2 border-(--vizhi-teal) p-4 sm:p-6 rounded-2xl shadow-[0_0_40px_rgba(0,201,167,0.3)]">
                        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-6">
                          ...
                          <span className="text-[10px] sm:text-[12px] font-black text-(--vizhi-teal) uppercase tracking-[0.2em]">
                            LIVE AI LECTURE
                          </span>
                        </div>
                        <p className="text-[14px] sm:text-[18px] text-(--vizhi-teal) font-black leading-snug sm:leading-relaxed italic mb-4 sm:mb-8">
                          "The heart's electrical system, starting from the SA
                          node, ensures synchronized contraction."
                        </p>
                        <div className="bg-white/5 p-3 sm:p-4 rounded-lg border border-white/10">
                          <div className="flex justify-between items-center mb-2">
                            <span className="text-[9px] sm:text-[10px] font-black text-white/60 uppercase">
                              Cycle
                            </span>
                            <span className="text-[11px] sm:text-[12px] font-black text-(--vizhi-teal)">
                              Systole
                            </span>
                          </div>
              ...
              <div className="flex justify-between items-center mb-1 px-3 sm:px-4 bg-black/40 border border-(--vizhi-teal)/20 rounded-xl py-1.5 backdrop-blur-md">
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black text-(--vizhi-teal) uppercase tracking-widest">
                      Global Operations Active
                    </span>
                  </div>
                  <div className="h-4 w-[1px] bg-white/10" />
                  <span className="text-[10px] font-mono text-white/60">
                    NODE: ENTERPRISE-HQ-01
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[12px] font-black text-(--vizhi-teal)">
                    94.8%
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
                ...
                >
                  <div className="bg-black/80 border border-(--vizhi-teal)/30 p-4 rounded-2xl shadow-[0_0_20px_rgba(0,201,167,0.1)] backdrop-blur-xl relative overflow-hidden">
                    ...
                    <h3 className="text-[11px] font-black text-(--vizhi-teal) uppercase mb-4 tracking-widest">
                      Active Logistics
                    </h3>
                    <div className="space-y-3">
                      {[
                        ...
                        >
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <span
                              className={`text-[9px] font-black ${ship.color} uppercase`}
                            >
                              {ship.status}
                            </span>
                          </div>
                ...
                >
                  <div className="bg-black/90 border-2 border-(--vizhi-teal)/50 p-4 sm:p-6 rounded-3xl shadow-[0_0_40px_rgba(0,201,167,0.2)] relative min-h-[260px] sm:min-h-[320px] flex flex-col items-center justify-center overflow-hidden">
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "linear-gradient(var(--vizhi-teal) 1px, transparent 1px), linear-gradient(90deg, var(--vizhi-teal) 1px, transparent 1px)",
                    ...
                    <div className="relative w-full h-40 sm:h-64 flex items-center justify-center">
                      ...
                      <Globe
                        size={110}
                        className="text-(--vizhi-teal) opacity-40 animate-pulse sm:w-[180px] sm:h-[180px]"
                      />
                    ...
                    <div className="mt-2 text-center">
                      <h4 className="text-[12px] sm:text-[14px] font-black text-(--vizhi-teal) uppercase tracking-[0.2em] mb-1">
                        Supply Chain
                      </h4>
                      <p className="text-[8px] sm:text-[10px] text-white/50 uppercase tracking-widest font-black">
                        Live Monitoring
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="bg-black/80 border border-orange-500/30 p-3 sm:p-4 rounded-2xl shadow-[0_0_20px_rgba(249,115,22,0.1)] backdrop-blur-xl">
                    ...
                    <div className="bg-orange-500/10 border border-orange-500/30 p-2 sm:p-3 rounded-xl mb-2 sm:mb-4">
                      <div className="text-[9px] font-black text-orange-500 mb-0.5 uppercase truncate">
                        Efficiency Alert
                      </div>
                      <p className="text-[8px] text-white/80 leading-tight line-clamp-2">
                        Bottleneck in APAC. +14h delay.
                      </p>
                    </div>
                  </div>

                  <div className="bg-black/80 border border-(--vizhi-teal)/30 p-3 sm:p-4 rounded-2xl hidden sm:block">
                    <h3 className="text-[11px] font-black text-(--vizhi-teal) uppercase mb-3 tracking-widest">
                      Global KPIs
                    </h3>
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between text-[9px] font-black text-white/60 mb-1 uppercase">
                          Resource Allocation
                        </div>
              ...
              <div className="flex h-full w-full max-w-[min(1200px,96vw)] flex-col gap-1.5 sm:gap-2 rounded-[1.25rem] bg-black/10 px-1 py-1 sm:px-2 sm:py-1.5">
                <div className="flex w-full justify-between items-center gap-2 px-1 sm:px-2 shrink-0">
                  <div className="flex items-center justify-center gap-2 bg-black/60 border border-[rgba(0,201,167,0.3)] rounded-full px-3 py-1.5">
                    ...
                    <span className="text-[9px] sm:text-[10px] font-black tracking-widest text-yellow-500 uppercase leading-none text-center">
                      AI Guided Repair Active
                    </span>
                  </div>
                  <div className="bg-black/80 border border-white/10 rounded-full px-3 py-1.5 flex items-center justify-center">
                    <span className="text-[9px] sm:text-[10px] font-black text-white/60 uppercase tracking-widest leading-none text-center">
                      Panel DB-09 / Circuit A
                    </span>
                  </div>
                </div>
                  ...
                  >
                    <div className="bg-black/80 border border-(--vizhi-teal)/30 p-2 sm:p-2.5 rounded-xl sm:rounded-2xl shadow-xl flex-1 flex flex-col min-h-0 overflow-hidden">
                      <div className="flex items-center gap-1.5 mb-1.5 shrink-0">
                        ...
                        <h3 className="text-[8px] sm:text-[9px] font-black text-(--vizhi-teal) uppercase tracking-widest">
                          Repair Instructions
                        </h3>
                      </div>
                      ...
                      <div className="space-y-1.5 flex-1 min-h-0 overflow-hidden">
                        <div className="p-1.5 sm:p-2 bg-(--vizhi-teal)/15 border border-(--vizhi-teal)/40 rounded-lg sm:rounded-xl relative overflow-hidden">
                          <div className="absolute top-0 right-0 p-1 bg-(--vizhi-teal) text-black text-[7px] font-black px-1.5">
                            CURRENT
                          </div>
                          <div className="text-[8px] font-black text-white/50 mb-1">
                            STEP 3 OF 5
                          </div>
                          <div className="text-[9px] sm:text-[11px] font-black text-(--vizhi-teal) leading-tight uppercase mb-1">
                            Plug the red wire into Terminal B4.
                          </div>
                          <div className="text-[8px] sm:text-[9px] font-bold text-yellow-300/90 uppercase leading-tight mb-1">
                            Keep the black probe in the COM port.
                          </div>
                        ...
                        <div className="p-1.5 sm:p-2 bg-white/5 border border-white/10 rounded-lg sm:rounded-xl opacity-80">
                          <div className="text-[8px] font-black text-white/30 mb-1 uppercase">
                            Next Step
                          </div>
                          <div className="text-[8px] sm:text-[10px] font-black text-white/70 leading-tight uppercase">
                            Set the multimeter to the AC 200V range.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-1.5 pt-1.5 border-t border-white/5 shrink-0">
                        <div className="flex items-center gap-1.5 p-1.5 sm:p-2 bg-blue-500/10 border border-blue-500/30 rounded-lg sm:rounded-xl">
                          ...
                          <p className="text-[8px] sm:text-[9px] text-blue-400/80 font-black uppercase leading-tight">
                            Stop immediately if you detect heat or sparks.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="bg-black/90 border-2 border-(--vizhi-teal)/40 rounded-2xl sm:rounded-3xl p-2 sm:p-3 shadow-2xl relative flex-1 flex flex-col items-center justify-center overflow-hidden min-h-0">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "radial-gradient(circle, var(--vizhi-teal) 1px, transparent 1px)",
                      ...
                      <div className="relative w-full aspect-square max-w-[120px] sm:max-w-[170px] flex items-center justify-center">
                        ...
                        <div className="z-10 bg-black/60 p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-(--vizhi-teal)/50 backdrop-blur-md text-center">
                          <div className="flex flex-col items-center gap-1.5 sm:gap-2">
                            <Wrench
                              size={24}
                              className="text-(--vizhi-teal) animate-bounce"
                            />
                            <div>
                              <div className="text-[8px] sm:text-[9px] font-black text-(--vizhi-teal) uppercase tracking-widest">
                                Alignment Active
                              </div>
                              <div className="text-[10px] sm:text-[12px] font-black text-white uppercase">
                                Port: Terminal B4
                              </div>
                              <div className="mt-1 text-[8px] font-black text-yellow-400 uppercase">
                      ...
                      <div className="mt-2 flex flex-wrap justify-center gap-1.5">
                        <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 bg-yellow-500/20 border border-yellow-500/50 rounded-full text-[7px] sm:text-[8px] font-black text-yellow-500 uppercase tracking-tighter">
                          Connect Here
                        </span>
                        <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 bg-red-500/20 border border-red-500/50 rounded-full text-[7px] sm:text-[8px] font-black text-red-300 uppercase tracking-tighter">
                          Red to B4
                        </span>
                        <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 bg-white/5 border border-white/10 rounded-full text-[7px] sm:text-[8px] font-black text-white/40 uppercase tracking-tighter">
                          Black to COM
                        </span>
                      </div>
                    </div>
                  ...
                  >
                    <div className="bg-black/80 border border-blue-500/30 p-2 sm:p-2.5 rounded-xl sm:rounded-2xl shadow-xl backdrop-blur-xl flex-1 flex flex-col min-h-0 overflow-hidden">
                      <div className="flex items-center gap-1.5 mb-2 shrink-0">
                        ...
                        <h3 className="text-[8px] sm:text-[9px] font-black text-blue-400 uppercase tracking-widest">
                          Meter Readings
                        </h3>
                      </div>
                      ...
                      <div className="space-y-2 flex-1 min-h-0 overflow-hidden">
                        <div className="flex flex-col gap-1">
                          <div className="flex justify-between text-[8px] sm:text-[9px] font-black text-white/40 uppercase">
                            Voltage (AC)
                          </div>
                          ...
                          <div className="mt-0.5 text-[8px] sm:text-[9px] font-black text-(--vizhi-teal) uppercase">
                            Live reading is updating now.
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            ...
                            <div className="text-sm sm:text-base font-black text-(--vizhi-teal) mono-numeric">
                              14.2 Ω
                            </div>
                          </div>
                          <div>
                        ...
                        <div className="pt-1.5 sm:pt-2 border-t border-white/10">
                          ...
                          <div className="text-[9px] font-black text-blue-400 text-right uppercase tracking-widest">
                            78% Nominal
                          </div>
                        </div>
                        ...
                        <div className="rounded-lg sm:rounded-xl border border-yellow-500/30 bg-yellow-500/10 p-1.5 sm:p-2">
                          ...
                          <p className="mt-1 text-[8px] sm:text-[9px] font-bold leading-snug text-yellow-100/80">
                            If the reading stays between 220V and 240V, the
              ...
              <div className="flex justify-between items-start mb-2 px-2">
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="hidden sm:flex items-center gap-2 bg-black/60 border border-white/10 rounded-full px-3 py-1">
                      ...
                      <span className="text-[9px] font-mono text-(--vizhi-teal) font-black">
                        8°10'30"N 77°25'45"E
                      </span>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="bg-black/60 border border-(--vizhi-teal)/30 rounded-lg px-3 py-1 w-fit">
                      <span className="text-[9px] font-black text-(--vizhi-teal) uppercase tracking-widest">
                        Secure Layer-7
                      </span>
                    </div>
                    ...
                    <div className="relative flex items-center gap-4 bg-black/40 px-3 py-1 rounded-full border border-white/5">
                      <div className="relative w-10 h-10">
                        ...
                        >
                          <span className="absolute top-0 text-[8px] font-black text-(--vizhi-teal)">
                            N
                          </span>
                          <span className="absolute right-0 text-[8px] font-black text-(--vizhi-teal)/40 rotate-90">
                            E
                          </span>
                          <span className="absolute bottom-0 text-[8px] font-black text-(--vizhi-teal)/40">
                            S
                          </span>
                          <span className="absolute left-0 text-[8px] font-black text-(--vizhi-teal)/40 -rotate-90">
                            W
                          </span>
                        </motion.div>
                        {/* Center Needle */}
                      ...
                      <div className="flex flex-col">
                        <span className="text-[12px] font-mono font-black text-(--vizhi-teal) drop-shadow-md">
                          342° NW
                        </span>
                ...
                <div className="relative w-24 h-24 sm:w-40 sm:h-40 bg-black/80 rounded-xl border-2 border-(--vizhi-teal)/50 overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <Crosshair
                      size={20}
                      className="text-(--vizhi-teal) drop-shadow-md"
                    />
                  </div>
                  <div className="absolute bottom-2 left-2 text-[8px] font-black text-(--vizhi-teal) uppercase opacity-60">
                    Map: Sector 7-B
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                ...
                <div className="md:col-span-4 space-y-3 hidden sm:block">
                  <div className="bg-black/80 border border-white/20 p-3 rounded-xl flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-[9px] font-black text-white/60 uppercase">
                        Threat
                      </div>
                  ...
                  <div className="bg-black/80 border border-white/20 p-3 rounded-xl flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-black text-(--vizhi-teal)">
                        94%
                      </div>
                    </div>
                  </div>
                ...
                <div className="md:col-span-8">
                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div className="flex flex-col">
                        <span className="text-[11px] font-black text-(--vizhi-teal) uppercase tracking-[0.2em] drop-shadow-md">
                          Incoming Comms
                        </span>
                        <span className="text-sm font-black text-(--vizhi-teal)">
                          COMMANDER HQ
                        </span>
                      </div>
                      <div className="ml-auto text-[10px] font-mono text-(--vizhi-teal) opacity-60">
                        ID: CMD-01-DELTA
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <p className="text-[14px] sm:text-[18px] text-(--vizhi-teal) font-black leading-snug italic drop-shadow-lg">
                        "UNITS 4 & 7, ADVANCE TO THE EXTRACTION POINT IN SECTOR
                        B. ENEMY SNIPER SPOTTED IN THE NORTH TOWER. EXTREME
                        CAUTION ADVISED."
                      </p>

                      <div className="flex items-center gap-3 pt-3 border-t border-white/10">
                        <div className="px-2 py-0.5 bg-red-500/20 border border-red-500/50 rounded text-[9px] font-black text-red-500 uppercase">
                          High Priority
                        </div>
                        <div className="px-2 py-0.5 bg-(--vizhi-teal)/20 border border-(--vizhi-teal)/50 rounded text-[9px] font-black text-(--vizhi-teal) uppercase">
                          Auth: L5
                        </div>
                      </div>
                    </div>
