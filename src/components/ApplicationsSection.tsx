...
export default function ApplicationsSection() {
  ...
  return (
    <section className="py-28 sm:py-32 md:py-40 lg:py-48 bg-[#050505] relative overflow-hidden">
      {/* Background radial gradient */}
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
      <div className="absolute bottom-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />

      <div className="max-w-7xl mx-auto px-6 lg:px-12 z-10 relative text-center mb-16 sm:mb-20 md:mb-24">
        <h2 className="vizhi-section-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-white mb-4 sm:mb-5 md:mb-6">
          Where Intelligence Meets{" "}
          <span className="text-white/40 italic">Reality</span>
        </h2>
      ...
      <div className="max-w-7xl mx-auto px-6 overflow-hidden pb-12">
        <div className="flex gap-6 w-max animate-infinite-scroll will-change-transform">
          {[...industries, ...industries].map((ind, i) => (
            ...
            >
              ...
              <div
                className={`absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl ${ind.color} opacity-5 rounded-full blur-[60px] translate-x-1/2 -translate-y-1/2 group-hover:opacity-20 transition-opacity duration-700`}
              />
              ...
              <div className="z-20 relative group-hover:opacity-0 transition-opacity duration-300">
                ...
                <h3 className="vizhi-card-title text-2xl font-bold text-white mb-2">
                  {ind.title}
                </h3>
                <p className="vizhi-card-copy text-sm text-white/50 leading-relaxed font-light">
                  {ind.desc}
                </p>
              </div>
            </motion.div>
